...
def main():
    ...
    for epoch in range(1, 2):
        ...
        print("---b2-----\n"+"-mse_loss--sum----")
        print("torch.Size([1, 1408, 8, 8]")
        print("panda 0.8158772587776184")
        print("panda 0.006139406003057957")
        print("dres 0.5812698006629944")
        print("dres 0.9858524203300476")
        print("dres-panda 1.3328396081924438")
        print("dres-panda 1.5738238096237183")
        ...
        loss6 = F.mse_loss(features3, features6, reduction='mean').item()
